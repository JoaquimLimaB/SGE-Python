...
from django.db.models.deletion import ProtectedError # Importe a exceção
...
class CategoryDeleteView(LoginRequiredMixin, PermissionRequiredMixin, DeleteView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            messages.error(
                request,
                f"A categoria '{self.object}' não pode ser excluída, pois existem produtos vinculados a ela."
            )
